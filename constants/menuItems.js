    ...
    [t("settings")]: {
      ...
      items: [
          ...
          items: [
            {
              ...
              name: t("userManagement"),
              icon: "Users",
              path: "/main/settings/userManagement?tab=0",
              roles: ["admin", "user", "owner"],
            },
            {
              key: "permission",
              name: t("permission"),
              icon: "Users",
              path: "/main/settings/userManagement?tab=1",
              roles: ["admin", "user", "owner"],
            },
            {
              key: "roleManagement",
              ...
              icon: "Users",
              path: "/main/settings/userManagement?tab=2",
              roles: ["admin", "user", "owner"],
            },
          ],
        },
        {
          ...
          icon: "Settings",
          path: "/main/settings/systemSettings",
          roles: ["admin", "user", "owner"],
        },
      ],
    },
