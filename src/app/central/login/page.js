...
// Improved background animation component
  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        this.color = `rgba(79, 70, 229, ${Math.random() * 1})`
      }
                ...
                <form onSubmit={handleSubmit}>
                  <motion.div className="space-y-5" variants={formVariants}>
                    <motion.div className="space-y-2" variants={itemVariants}>
                      ...
                      <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                          <Mail className="h-5 w-5 text-gray-400 group-focus-within:text-[#4F46E5] transition-colors duration-200" />
                        </div>
                        <input
                          type="email"
                          id="email"
                    ...
                    <motion.div className="space-y-2" variants={itemVariants}>
                      ...
                      <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                          <Lock className="h-5 w-5 text-gray-400 group-focus-within:text-[#4F46E5] transition-colors duration-200" />
                        </div>
                        <input
